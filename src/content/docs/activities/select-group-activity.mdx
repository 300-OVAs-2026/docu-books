...
<CoreRepoInfo corePath="components/activities/select-group-activity/select-group-activity.tsx" />
...
<CoreRepoInfo corePath="components/activities/select-group-activity/select-group-element.tsx" />
...
<CoreRepoInfo corePath="components/activities/select-group-activity/select-group-button.tsx" />