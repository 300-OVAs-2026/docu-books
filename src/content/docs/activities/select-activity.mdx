...
<CoreRepoInfo corePath="components/activities/select-activity/select-activity.tsx" />
...
<CoreRepoInfo corePath="components/activities/select-activity/select-element.tsx" />
...
<CoreRepoInfo corePath="components/activities/select-activity/select-button.tsx" />