...
>
  ...
  {/* Representación visual opcional de la palabra en la matrix usando answers.question1.array ... */}
...
<CoreRepoInfo corePath="components/activities/crossword-input/crossword-activity.tsx" />
...
<CoreRepoInfo corePath="components/activities/crossword-input/crossword-input.tsx" />
