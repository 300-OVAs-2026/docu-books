...
<CoreRepoInfo corePath="components/features/modal-bibliography/modal-bibliography.tsx" />
...
<CoreRepoInfo corePath="components/features/modal-bibliography/modal-bibliography-link.tsx" />
