...
<RaceCard questionCount={LENGTH_QUESTION}>
  <Panel stars={Stars}>
    ...
    {/* Pregunta 2, 3, 4... mismo patrón + modal y toast */}
...
<CoreRepoInfo corePath="components/games/game-race-card/race-card.tsx" />
...
<CoreRepoInfo corePath="components/games/game-race-card/race-card-initial.tsx" />
...
<CoreRepoInfo corePath="components/games/game-race-card/race-card-scene.tsx" />
...
<CoreRepoInfo corePath="components/games/game-race-card/race-card-input.tsx" />
