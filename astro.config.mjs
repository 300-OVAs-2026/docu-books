      ...
      rollupOptions: {
        output: {
          manualChunks(id) {
            ...
            if (id.includes('node_modules/@react-aria') || id.includes('node_modules/@react-stately') || id.includes('node_modules/react-stately')) return 'vendor-react-aria';
            if (id.includes('node_modules/@atlaskit')) return 'vendor-atlaskit';
            if (id.includes('node_modules/react-popper') || id.includes('node_modules/react-draggable') || id.includes('node_modules/@popperjs')) return 'vendor-popper';
